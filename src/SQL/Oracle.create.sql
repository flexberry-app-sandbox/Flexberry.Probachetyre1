...
ALTER TABLE "ТЧВхСотруд"
	ADD CONSTRAINT "ТЧВхСотруд_FС_1106" FOREIGN KEY ("Сотрудник") REFERENCES "Сотрудник" ("primaryKey");

CREATE INDEX "ТЧВхСотруд_IС_8117" on "ТЧВхСотруд" ("Сотрудник");

ALTER TABLE "ТЧВхСотруд"
	ADD CONSTRAINT "ТЧВхСотруд_FФ_6477" FOREIGN KEY ("ФормаРегВхода") REFERENCES "ФормаРегВхода" ("primaryKey");

CREATE INDEX "ТЧВхСотруд_IФ_3158" on "ТЧВхСотруд" ("ФормаРегВхода");
